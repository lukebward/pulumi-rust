...
pub struct SomeResourceArgs {
    pub builtins: Option<pulumi::Output<std::string::String>>,
    pub lambda: Option<pulumi::Output<std::string::String>>,
    pub property: Option<pulumi::Output<std::string::String>>,
}
