...
pub struct ContainerArgs {
    pub inputs: Option<pulumi::Output<std::vec::Vec<std::string::String>>>,
}
...
pub struct MapContainerArgs {
    pub tags: Option<pulumi::Output<std::collections::BTreeMap<std::string::String, std::string::String>>>,
}
...
pub struct ReceiverArgs {
    pub details: Option<std::vec::Vec<crate::types::DetailArgs>>,
}
...
pub struct GetValuesArgs {
    pub names: Option<pulumi::Output<std::vec::Vec<std::string::String>>>,
}
...
pub mod types {
    ...
    pub struct DetailArgs {
        pub key: Option<pulumi::Output<std::string::String>>,
