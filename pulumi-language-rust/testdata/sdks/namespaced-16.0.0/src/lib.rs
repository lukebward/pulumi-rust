...
pub struct ResourceArgs {
    pub resource_ref: Option<pulumi::Output<pulumi::PropertyValue>>,
...
impl ResourceArgs {
    pub fn into_inputs(self) -> std::vec::Vec<(std::string::String, pulumi::Output<pulumi::PropertyValue>)> {
        ...
        if let Some(v) = self.resource_ref {
            inputs.push(("resourceRef".to_string(), v.cast()));
        }
...
impl Resource {
    pub fn new(ctx: &pulumi::Context, name: &str, args: ResourceArgs, options: pulumi::ResourceOptions) -> Resource {
        let resource = ctx.register_resource(pulumi::RegisterRequest {
            type_: "namespaced:index:Resource".to_string(),
            name: name.to_string(),
            custom: true,
            remote: false,
...
impl Provider {
    pub fn new(ctx: &pulumi::Context, name: &str, args: ProviderArgs, options: pulumi::ResourceOptions) -> Provider {
        let resource = ctx.register_resource(pulumi::RegisterRequest {
            type_: "pulumi:providers:namespaced".to_string(),
            name: name.to_string(),
            custom: true,
            remote: false,
            version: "16.0.0".to_string(),
