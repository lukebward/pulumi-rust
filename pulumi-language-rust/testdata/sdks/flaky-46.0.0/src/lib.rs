...
pub struct FlakyCreateArgs {
}

impl FlakyCreateArgs {
...
pub struct FlakyCreate {
    resource: pulumi::Resource,
}

impl FlakyCreate {
    pub fn new(ctx: &pulumi::Context, name: &str, args: FlakyCreateArgs, options: pulumi::ResourceOptions) -> FlakyCreate {
        let resource = ctx.register_resource(pulumi::RegisterRequest {
            type_: "flaky:index:FlakyCreate".to_string(),
            name: name.to_string(),
            custom: true,
            remote: false,
...
impl Provider {
    pub fn new(ctx: &pulumi::Context, name: &str, args: ProviderArgs, options: pulumi::ResourceOptions) -> Provider {
        let resource = ctx.register_resource(pulumi::RegisterRequest {
            type_: "pulumi:providers:flaky".to_string(),
            name: name.to_string(),
            custom: true,
            remote: false,
            version: "46.0.0".to_string(),
