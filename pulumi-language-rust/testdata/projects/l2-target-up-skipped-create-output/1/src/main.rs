...
fn main() {
    pulumi::run(|ctx| async move {
        ...
        let skipped = pulumi_nestedobject::Container::new(&ctx, "skipped", pulumi_nestedobject::ContainerArgs { inputs: Some(pulumi::pv::array(vec![pulumi::ops::to_string(pulumi::pv::string("b"))]).cast()) }, pulumi::ResourceOptions::default());
